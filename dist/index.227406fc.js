...
const toDoPage = function(params) {
    ...
    pageHeader.classList.add('homePage-header');
    const logoElm = _logoDefault.default();
    const h1 = _headerDefault.default('h1', 'Bingo is life');
    const linkElm = _linkDefault.default('404', '/pageNotFound');
    linkElm.addEventListener('click', onRequestNewPage);
    pageHeader.append(logoElm);
    pageHeader.append(h1);
    pageHeader.append(linkElm);
...
},{"../icon/logo":"cA0bR","../components/header":"fXKjJ","../components/link":"jlxOi","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc","../routes/router":"3ISf2"}]},["hkXzs","23obh"], "23obh", "parcelRequirea107")
